...
def get_grade_by_github_title(student_github, project_title):
    ...
    print """project_title: {title}
student_github: {student}
grade : {grade}""".format(student=row[0], title=row[1], grade=row[2])
...
def assign_grade(github, title, grade):
    ...
    {student_github} score on {project_title}: {grade}""".format(
        student_github=github, project_title=title, grade=grade)
